...
<!-- badges: start -->
[![Travis build status](https://travis-ci.com/akbarpunjwani/msdr-capstone-eqvis.svg?branch=main)](https://travis-ci.com/akbarpunjwani/msdr-capstone-eqvis)
<!-- badges: end -->
...
The EQVIS, which stands for EarthQuake VISualizations, provide a sample data set for public access to analyze the earthquakes occurrences as reported at NOAA. 
